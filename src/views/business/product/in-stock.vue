<template>
    <div id="inStocks">
        ...
        <el-breadcrumb separator="/" style="padding-left:10px;padding-bottom:10px;font-size:12px;">
            ...
            <el-breadcrumb-item>廢棄物入库</el-breadcrumb-item>
        </el-breadcrumb>
        <!-- 卡片區域 -->
        <el-card>
            <!-- 搜索部分 -->
            <el-form size="small" :inline="true" :model="queryMap" class="demo-form-inline">
                <el-form-item label="類型">
                    <el-select  clearable  v-model="queryMap.type" placeholder="請選擇入库類型">
            ...
            <el-table empty-text="暫無數據"  size="mini" v-loading="loading" :data="tableData" border style="width: 100%;" height="420">
                ...
                <el-table-column prop="productNumber" label="數量" sortable width="100"></el-table-column>
                <el-table-column prop="phone" label="聯繫方式" width="150"></el-table-column>
                ...
                <el-table-column prop="supplierName" label="廢棄物提供方" width="180"></el-table-column>
                <el-table-column prop="createTime" label="入库時間" sortable width="180"></el-table-column>
            ...
            <el-dialog title="入库明细" :visible.sync="dialogVisible" @close="closeDetail" width="60%">
                ...
                <el-steps simple v-if="pStatus==0"  style="margin-left: 10px;margin-bottom: 5px;" :space="200" :active="3" finish-status="success">
                    <el-step title="提交入库單" ></el-step>
                    <el-step title="审核入库單"></el-step>
                    <el-step title="進入库存"></el-step>
                </el-steps>
        ...
        methods: {
            ...
            async publish(id){
                ...
                if (!res.success) {
                    ...
                    return this.$message.success("入库已审核通過");
                }
            },
            /**
             * 從回收站恢复
            ...
            async del(id) {
                ...
                if (!res.success) {
                    ...
                    await this.loadTableData();
                    return this.$message.success("删除入库單記錄成功");
                }
            },
            /**
             * 查看入库單明细
